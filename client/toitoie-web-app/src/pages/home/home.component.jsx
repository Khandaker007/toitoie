  ...
  return (
    <div className='home'>
        ...
        <div className="home__offer">
          <h1 className='home__offer--heading heading-1 mb-4'>What we <span className='clr-gradient'>Offer</span></h1>
        ...
        <div className="home__packages">
          <div className="home__packages--container-text">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sit tortor nec tristique erat massa, fringilla libero volutpat. Elementum eget mi sit dolor, lorem quam mauris. Ornare amet, sit urna pellentesque nunc vestibulum pulvinar.</p>
          </div>
